        ...
        <div className="flex flex-col items-center justify-center px-4 py-10 bg-gray-700 mx-8 md:mx-0 shadow rounded-3xl md:p-10">
            {!mostrarTabla ? (
                <div className="w-full md:w-2/3">
                    <h1 className="text-center text-3xl font-semibold mb-6 text-green-500">Calculador de Interés Simple</h1>
                    <div className="mb-4">
                    ...
                    <div className="text-center">
                        <h1 className="text-2xl font-semibold mb-2 text-green-500">Interés Total: {resultado !== null ? `$ ${resultado.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : 'Ingrese datos válidos'}</h1>
                        <h1 className="text-2xl font-semibold mb-4 text-green-500">Monto Final: {resultado !== null && interes !== 0 && periodo !== 0 ? `$ ${(resultado + capital).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : '...'}</h1>
                    </div>
